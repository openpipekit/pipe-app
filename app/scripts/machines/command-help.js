window.CommandHelp = {
  ...
  fn: function(inputs, exits) {
    ...
    self.getStdout({command: command}, {
      error: function(result) {
        return exits.error(result)
      },
      success: function(result) {
        self.convertStdoutToOptionsText({stdout: result}, {
          error: function(result) {
            return exits.error(result)
          },
          success: function(result) {
            result.forEach(function(optionText) {
              self.convertOptionTextToOptionObject({optionText: optionText}, {
                error: function(result) {
                  return exits.error(result)
                },
                success: function(result) {
  ...
  getStdout: function(inputs, exits) {
  ...
  convertStdoutToOptionsText: function(inputs, exits) {
  ...
  convertOptionTextToOptionObject: function(inputs, exits) {
